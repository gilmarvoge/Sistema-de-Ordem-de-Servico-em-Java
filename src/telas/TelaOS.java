...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    //método para setar o número ID no caixa de texto
    ...
    private void emitir_os() {
        ...
        try {
            ...
            pst.setString(3, txtOsEquip.getText().toString());
            pst.setString(4, txtOsDef.getText().toString());
            pst.setString(5, txtOsServ.getText().toString());
            pst.setString(6, txtOsTec.getText().toString());
            // .replace substitui a virgula pelo ponto
            pst.setString(7, txtOsValor.getText().replace(",", ".").toString());
            pst.setString(8, txtCliId.getText().toString());
    ...
    private void pesquisar_os() {
        ...
        try {
            ...
            rs = pst.executeQuery();
            if (rs.next()) {
                txtOS.setText(rs.getString(1)); //o número 1 se refere a primeira coluna do banco, no caso é a OS
                txtData.setText(rs.getString(2));
                //setando os radiobutton
        ...
        try {
            ...
            if ((txtCliId.getText().isEmpty() || txtOsEquip.getText().isEmpty() || txtOsDef.getText().isEmpty())) {
                ...
                if (adicionado > 0) {
                    ...
                    txtOsTec.setText(null);
                    txtOsValor.setText(null);
                    //habilitar os objetos que foram desabilitados quando clicado em pesquisar
    ...
    private void excluir_os() {
        ...
        if (confirma == JOptionPane.YES_OPTION) {
            ...
            try {
                pst = conexao.prepareStatement(sql);
                pst.setString(1, txtOS.getText()); //VAI PEGAR O NUMERO DA os E SETAR NA QUERY
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/pesquisar.png"))); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtCliId, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        btnOsImprimir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/telas/imprimir.png"))); // NOI18N
        btnOsImprimir.setToolTipText("Imprimir OS");
        btnOsImprimir.setAutoscrolls(true);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(cboOsSit, javax.swing.GroupLayout.PREFERRED_SIZE, 135, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtOsEquip, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 515, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(78, 78, 78)
    ...
    //chamando o método setar_campos para setar o número ID, quando for clicado na tabelinha
    private void tblClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblClientesMouseClicked
        setar_campos();
    }//GEN-LAST:event_tblClientesMouseClicked

    //radion button orçamento, se for clicar nessa opção vai proceder com o evento abaixo
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        // atribuindo um texto a variavel "tipo" se selecionado
        tipo = "Orçamento";
    }//GEN-LAST:event_rbtOrcActionPerformed
    //radion button ordem de serviço, se for clicar nessa opção vai proceder com o evento abaixo
    ...
    //clamando o metodo para excluir uma OS
